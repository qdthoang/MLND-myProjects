...
def predictions_1(data):
    ...
    for _, passenger in data.iterrows():
        ...
        # Check passenger's sex, then give prediction
...
def predictions_2(data):
    ...
    for _, passenger in data.iterrows():
       ...
       # Check passenger's sex and/or age
        if passenger['Sex'] == 'female':
            predictions.append(1) # survived
...
# Age for female of different classes
    ...
    for _, passenger in data.iterrows():
        ...
        if passenger['Sex'] == 'female':
            if passenger['Pclass'] == 1 and passenger['Age'] < 10:
                ...
                predictions.append(0)
            elif passenger['Pclass'] == 3 and passenger['Fare'] > 20:
                predictions.append(0)
            else:
...
# **Answer**: *A real-world scenario would be predicting a benign or malignant tumor. Features that might be helpful include size of tumor, growth speed and growth type*
